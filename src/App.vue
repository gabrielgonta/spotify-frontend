...
<template>
    <div>
            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://avatars.githubusercontent.com/u/146724165?v=4"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Gabriel Gonta</div>
        ...
        <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
            ...
            <ul>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">My Playlist</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">TØP Mix</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Sunday's vibe</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Chill</li>
            </ul>
        </div>
    </div>
